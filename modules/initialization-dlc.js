...
Hooks.once("ready", async () => {
    ...
    /** Pomocnik do wczytywania gazetteer.json dla handlu rzecznego (Up in Arms) */
    ...
    // Sea of Claws
    // =======================================================================
    if (game.modules.get("wfrp4e-soc")?.active) {
        const maritime = game.wfrp4e?.trade?.tradeData?.maritime;
        if (maritime) {
            Object.assign(maritime.cargoTypes ??= {}, {
                grain: "Zboże",
                arms: "Broń",
                luxuries: "Luksusy",
                metal: "Metal",
                ...
                salt: "Sól",
                oil: "Oliwa",
                saltfish: "Solone Ryby",
                shipParts: "Części Okrętowe",
            });
        }
    }

    // =======================================================================
    // Tłumaczenie pór roku dla handlu (/trade)
    // =======================================================================
    if (game.wfrp4e?.trade) {
        game.wfrp4e.trade.seasons = {
