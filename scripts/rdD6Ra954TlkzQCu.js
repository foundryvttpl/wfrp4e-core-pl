...
const techniques = await warhammer.utility.findAllItems("wfrp4e-helf.technique", "Wczytywanie Technik", true);
const choice = await ItemDialog.create(techniques, 1, {text: "Wybierz Taniec Miecza", title: this.effect.name});
if (choice.length) {
