...
if (roll.total == 1)
{
    this.item.updateSource({"system.description.value" : this.item.system.description.value += `<p><strong>${this.effect.name}</strong>: Bron liczy sie jako @Corruption[minor]{pomniejsze zrodlo Zepsucia}.</p>`});
}
