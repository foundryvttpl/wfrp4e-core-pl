...
{
  const heatBased = await foundry.applications.api.DialogV2.confirm({window : {title : this.effect.name}, content : "Zastosowac ochrone przed atakami opartymi na goracu?"})
